...
namespace CensusAnalyzerMain
{
    public class StateCensusException : Exception
    {
        ...
        {
            INCORRECT_FILE, FILE_NOT_FOUND, NAME_IS_NOT_CORRECT, INCORRECT_DELIMETER, INCORRECT_HEADER, HEADER_NAME_NOT_CORRECT, HEADER_LENGTH_NOT_EQUAL
        }
        TypeOfExceptions type;
