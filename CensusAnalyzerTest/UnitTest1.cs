...
namespace CensusAnalyzerTest
{
    public class Tests
    {
        ...
        public void CheckNumberOfRecordMatches()
        {
            ...
            string path = @"C:\Users\HP\source\repos\CensusAnalyzers\CensusAnalyzerMain\IndiaStateCensusData.csv";
        ...
        public void CheckWrongFileType()
        {
            ...
            {
                StateCensusAnalyser read = new StateCensusAnalyser();
                string path = @"C:\Users\HP\source\repos\CensusAnalyzers\CensusAnalyzerMain\IndiaStateCensusData.txt";
                //int record = read.csvFileReadMethod(path, ',');
            }
            catch (StateCensusException e)
